                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2 flex-column flex-md-row">
                                                        <select class='form-select w-auto' name="status[<?= $application['id'] ?>]" id="new_status_id">
                                                        ...
                                                        <button class="btn btn-primary btn-sm" type='submit' name='status_update' value="<?= htmlspecialchars($application['id']) ?>">Обновить</button>
                                                    </div>
                                                </td>
                                            </tr>
