...
<form action="../handlers/new_app_h.php" method='post'>
    <h2  class="card-title text-center mb-4">Запись на услугу в городской центр услуг</h2>
        <?php 
        show_alert();
        ?>
...
<?php endforeach;?>
   ...
   <button class="col-12 col-md-6 w-100 btn btn-primary" type='submit'>Записаться на услугу</button>
